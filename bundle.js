! function(e) {
    ...
    function w(e) {
        y.start((function(t, n, a) {
            ...
            e && (c += "&token=" + encodeURIComponent(e)), r.connect(c, (function(e) {
                Bi(), setInterval(() => Bi(), 2500), e ? ut(e) : (he.onclick = s.checkTrusted((function() {
                    ! function() {
                        var e = ++wt > 1
                            , t = Date.now() - vt > kt;
                        e && t ? (vt = Date.now(), bt()) : Sn()
                    }()
                    ...
                    mn(), "block" != qe.style.display ? _t() : qe.style.display = "none"
                })), s.hookTouchEvents(me), ye.onclick = s.checkTrusted((function() {
                    "block" != Ke.style.display ? (Ke.style.display = "block", qe.style.display = "none", sn(), Nt()) : Ke.style.display = "none"
                    ...
                    for (var e = 0; e < Rn.length; ++e) {
                        ...
                        t.onload = function() {
                            this.isLoaded = !0
                        }, t.src = ".././img/icons/" + Rn[e] + ".png", On[Rn[e]] = t
                    }
                }(), Ae.style.display = "none", Ee.style.display = "block", De.value = E("moo_name") || "", function() {
                    var e = E("native_resolution");
                    $t(e ? "true" == e : "undefined" != typeof cordova), A = "true" == E("show_ping"), Te.hidden = !A, E("moo_moosic"), setInterval((function() {
                    ...
                    for (t = 0; t < l.list.length + l.weapons.length; ++t) ! function(e) {
                        ...
                        if (n.translate(t.width / 2, t.height / 2), n.imageSmoothingEnabled = !1, n.webkitImageSmoothingEnabled = !1, n.mozImageSmoothingEnabled = !1, l.weapons[e]) {
                            ...
                            n.globalAlpha = 1, n.drawImage(i, -a / 2, -a / 2, a, a), n.fillStyle = "rgba(0, 0, 70, 0.1)", n.globalCompositeOperation = "source-atop", n.fillRect(-a / 2, -a / 2, a, a), document.getElementById("actionBarItem" + e).style.backgroundImage = "url(" + t.toDataURL() + ")", (r = document.getElementById("actionBarItem" + e)).onmouseover = s.checkTrusted((function() {
                                St(l.list[e - l.weapons.length])
                            })), r.onclick = s.checkTrusted((function() {
                                xn(e - l.weapons.length)
                            })), s.hookTouchEvents(r)
                        }
                    }(t);
                    De.ontouchstart = s.checkTrusted((function(e) {
                        e.preventDefault();
    ...
    var M, A, P, B, C, O, R, j, _, U, D, L, F, z, H = E("moofoll")
        ...
        , N = []
        , G = []
        , J = new p(d, G, W, Y, tt, l, o, s)
        , K = n(70)
        , Q = n(71)
        , $ = new K(Y, Q, W, l, null, o, s)
        , Z = 1
        , ee = 0
        , te = 0
        , ne = 0
        ...
        , De = document.getElementById("nameInput")
        ...
        , Ye = document.getElementById("allianceHolder")
    ...
    var gt = document.getElementById("pre-content-container")
        , mt = null
        , yt = null;
    window.cpmstarAPI((function(e) {
        e.game.setTarget(gt), yt = e
    }));
    var kt = 3e5
        , vt = 0
        , wt = 0;
    ...
    function bt() {
        if (!cpmstarAPI || !yt) return console.log("Failed to load video ad API", !!cpmstarAPI, !!yt), void Sn();
        (mt = new yt.game.RewardedVideoView("rewardedvideo")).addEventListener("ad_closed", (function(e) {
            console.log("Video ad closed"), xt()
        })), mt.addEventListener("loaded", (function(e) {
            console.log("Video ad loaded"), mt.show()
        })), mt.addEventListener("load_failed", (function(e) {
            console.log("Video ad load failed", e), xt()
        })), mt.load(), gt.style.display = "block"
    }

    function xt() {
        gt.style.display = "none", Sn()
    }
    ...
    function Ct(e) {
        X.push(e), "block" == qe.style.display && _t()
    }
    ...
    function Rt(e) {
        At = e, "block" == qe.style.display && _t()
    }
    ...
    function _t() {
        if (R && R.alive) {
            if (sn(), Ke.style.display = "none", qe.style.display = "block", s.removeAllChildren(Ye), R.team)
                for (var e = 0; e < At.length; e += 2) ! function(e) {
                    var t = s.generateElement({
                        class: "allianceItem"
                        , style: "color:" + (At[e] == R.sid ? "#fff" : "rgba(255,255,255,0.6)")
                        , text: At[e + 1]
                        , parent: Ye
                    });
                    R.isOwner && At[e] != R.sid && s.generateElement({
                        class: "joinAlBtn"
                        , text: "Kick"
                        , onclick: function() {
                            Dt(At[e])
    ...
    function Ut(e) {
        r.send("11", Mt[0].sid, e), Mt.splice(0, 1), Bt()
    }
    ...
    function Xt(e, t, n) {
        n ? e ? R.tailIndex = t : R.tails[t] = 1 : e ? R.skinIndex = t : R.skins[t] = 1, "block" == Ke.style.display && Nt()
    }

    function Nt() {
        if (R) {
            s.removeAllChildren(Qe);
            for (var e = Wt, t = e ? et : Ze, n = 0; n < t.length; ++n) t[n].dontSell || function(n) {
    ...
    function Kt() {
        Ke.style.display = "none", qe.style.display = "none", sn()
    }
    ...
    function $t(e) {
        M = e, V = e && window.devicePixelRatio || 1, xe.checked = e, I("native_resolution", e.toString()), hn()
    }

    function Zt() {
        for (var e = "", t = 0; t < o.skinColors.length; ++t) e += t == se ? "<div class='skinColorItem activeSkin' style='background-color:" + o.skinColors[t] + "' onclick='selectSkinColor(" + t + ")'></div>" : "<div class='skinColorItem' style='background-color:" + o.skinColors[t] + "' onclick='selectSkinColor(" + t + ")'></div>";
        Ge.innerHTML = e
    }
    var en = document.getElementById("chatBox")
    ...
    function nn() {
        an ? setTimeout((function() {
            ...
            e && rn(e)
        }), 1) : "block" == tn.style.display ? (en.value && rn(en.value), sn()) : (Ke.style.display = "none", qe.style.display = "none", tn.style.display = "block", en.focus(), mn()), en.value = ""
    }
    ...
    function sn() {
        en.value = "", tn.style.display = "none"
    }
    var an, on, cn = ["cunt", "whore", "fuck", "shit", "faggot", "nigger", "nigga", "dick", "vagina", "minge", "cock", "rape", "cum", "sex", "tits", "penis", "clit", "pussy", "meatcurtain", "jizz", "prune", "douche", "wanker", "damn", "bitch", "dick", "fag", "bastard"];
    ...
    function hn() {
        ...
        var e = Math.max(F / ae, z / oe) * V;
        ve.width = F * V, ve.height = z * V, ve.style.width = F + "px", ve.style.height = z + "px", we.setTransform(e, 0, 0, e, (F * V - ae * e) / 2, (z * V - oe * e) / 2)
    }

    function un(e) {
        (an = e) ? Me.classList.add("touch"): Me.classList.remove("touch")
    }

    function fn(e) {
        e.preventDefault(), e.stopPropagation(), un(!0);
        for (var t = 0; t < e.changedTouches.length; t++) {
            var n = e.changedTouches[t];
            n.identifier == ie.id ? (ie.id = -1, wn()) : n.identifier == re.id && (re.id = -1, R.buildIndex >= 0 && (O = 1, kn()), O = 0, kn())
        }
    }

    function dn() {
        return R ? (-1 != re.id ? on = Math.atan2(re.currentY - re.startY, re.currentX - re.startX) : R.lockDir || an || (on = Math.atan2(ne - z / 2, te - F / 2)), s.fixTo(on || 0, 2)) : 0
    }
    window.addEventListener("resize", s.checkTrusted(hn)), hn(), un(!1), window.setUsingTouch = un, ve.addEventListener("touchmove", s.checkTrusted((function(e) {
        e.preventDefault(), e.stopPropagation(), un(!0);
        for (var t = 0; t < e.changedTouches.length; t++) {
            var n = e.changedTouches[t];
            n.identifier == ie.id ? (ie.currentX = n.pageX, ie.currentY = n.pageY, wn()) : n.identifier == re.id && (re.currentX = n.pageX, re.currentY = n.pageY, O = 1)
        }
        ...
        for (var t = 0; t < e.changedTouches.length; t++) {
            var n = e.changedTouches[t];
            n.pageX < document.body.scrollWidth / 2 && -1 == ie.id ? (ie.id = n.identifier, ie.startX = ie.currentX = n.pageX, ie.startY = ie.currentY = n.pageY, wn()) : n.pageX > document.body.scrollWidth / 2 && -1 == re.id && (re.id = n.identifier, re.startX = re.currentX = n.pageX, re.startY = re.currentY = n.pageY, R.buildIndex < 0 && (O = 1, kn()))
        }
    })), !1), ve.addEventListener("touchend", s.checkTrusted(fn), !1), ve.addEventListener("touchcancel", s.checkTrusted(fn), !1), ve.addEventListener("touchleave", s.checkTrusted(fn), !1), ve.addEventListener("mousemove", (function(e) {
        e.preventDefault(), e.stopPropagation(), un(!1), te = e.clientX, ne = e.clientY
    ...
    function yn() {
        return "block" != qe.style.display && "block" != tn.style.display
    }

    function kn() {
        R && R.alive && r.send("c", O, R.buildIndex >= 0 ? dn() : null)
    }
    window.addEventListener("keydown", s.checkTrusted((function(e) {
        var t = e.which || e.keyCode || 0;
        27 == t ? Kt() : R && R.alive && yn() && (pn[t] || (pn[t] = 1, 69 == t ? r.send("7", 1) : 67 == t ? (Et || (Et = {}), Et.x = R.x, Et.y = R.y) : 88 == t ? (R.lockDir = R.lockDir ? 0 : 1, r.send("7", 0)) : null != R.weapons[t - 49] ? xn(R.weapons[t - 49], !0) : null != R.items[t - 49 - R.weapons.length] ? xn(R.items[t - 49 - R.weapons.length]) : 81 == t ? xn(R.items[0]) : 82 == t ? bn() : gn[t] ? wn() : 32 == t && (O = 1, kn())))
    }))), window.addEventListener("keyup", s.checkTrusted((function(e) {
        if (R && R.alive) {
            var t = e.which || e.keyCode || 0;
            13 == t ? nn() : yn() && pn[t] && (pn[t] = 0, gn[t] ? wn() : 32 == t && (O = 0, kn()))
        }
    })));
    var vn = void 0;
    ...
    function wn() {
        var e = function() {
            ...
            if (-1 != ie.id) e += ie.currentX - ie.startX, t += ie.currentY - ie.startY;
                ...
                for (var n in gn) {
                    var i = gn[n];
                    e += !!pn[n] * i[0], t += !!pn[n] * i[1]
                }
            return 0 == e && 0 == t ? void 0 : s.fixTo(Math.atan2(t, e), 2)
        }();
        (null == vn || null == e || Math.abs(e - vn) > .3) && (r.send("33", e), vn = e)
    }
    ...
    function Sn() {
        window.FRVR && window.FRVR.tracker.levelStart("game_start"), I("moo_name", De.value), !ce && r.connected && (ce = !0, x.stop("menu"), ft("Loading..."), r.send("sp", {
                name: De.value
                , moofoll: H
                , skin: se
            }))
    ...
    function In(e) {
        Ae.style.display = "none", Ee.style.display = "block", le.style.display = "none", pn = {}, j = e, O = 0, ce = !0, Tn && (Tn = !1, N.length = 0)
    }
    ...
    function An() {
        ...
        Pe.style.display = "none", Kt(), Tt = {
            x: R.x
            , y: R.y
        }, Ae.style.display = "none", Ne.style.display = "block", Ne.style.fontSize = "0px", Mn = 0, setTimeout((function() {
    ...
    function _n(e, t) {
        if (R.upgradePoints = e, R.upgrAge = t, e > 0) {
            jn.length = 0, s.removeAllChildren(He);
            for (var n = 0; n < l.weapons.length; ++n) l.weapons[n].age == t && (null == l.weapons[n].pre || R.weapons.indexOf(l.weapons[n].pre) >= 0) && (s.generateElement({
                ...
                , parent: He
            }).style.backgroundImage = document.getElementById("actionBarItem" + n).style.backgroundImage, jn.push(n));
            for (n = 0; n < l.list.length; ++n)
                if (l.list[n].age == t && (null == l.list[n].pre || R.items.indexOf(l.list[n].pre) >= 0)) {
                    ...
                    s.generateElement({
                        ...
                        , parent: He
                    }).style.backgroundImage = document.getElementById("actionBarItem" + i).style.backgroundImage, jn.push(i)
                } for (n = 0; n < jn.length; n++) ! function(e) {
                var t = document.getElementById("upgradeItem" + e);
                t.onmouseover = function() {
                    l.weapons[e] ? St(l.weapons[e], !0) : St(l.list[e - l.weapons.length])
                }, t.onclick = s.checkTrusted((function() {
                    r.send("6", e)
                })), s.hookTouchEvents(t)
            }(jn[n]);
            jn.length ? (He.style.display = "block", Ve.style.display = "block", Ve.innerHTML = "SELECT ITEMS (" + e + ")") : (He.style.display = "none", Ve.style.display = "none", St())
        } else He.style.display = "none", Ve.style.display = "none", St()
    }
    ...
    function Fn(e, t, n, i) {
        we.save(), we.setTransform(1, 0, 0, 1, 0, 0), we.scale(V, V);
        var r = 50;
    ...
    function zn(e, t, n) {
        for (var i = 0; i < G.length; ++i)(_ = G[i]).active && _.layer == e && (_.update(P), _.active && ki(_.x - t, _.y - n, _.scale) && (we.save(), we.translate(_.x - t, _.y - n), we.rotate(_.dir), Vn(0, 0, _, we, 1), we.restore()))
    }
    var Hn = {};
    ...
    function Yn(e, t, n) {
        for (var i, r, s, a = 0; a < N.length; ++a)(_ = N[a]).active && (r = _.x + _.xWiggle - t, s = _.y + _.yWiggle - n, 0 == e && _.update(P), _.layer == e && ki(r, s, _.scale + (_.blocker || 0)) && (we.globalAlpha = _.hideFromEnemy ? .6 : 1, _.isItem ? (i = ri(_), we.save(), we.translate(r, s), we.rotate(_.dir), we.drawImage(i, -i.width / 2, -i.height / 2), _.blocker && (we.strokeStyle = "#db6e6e", we.globalAlpha = .3, we.lineWidth = 6, si(0, 0, _.blocker, we, !1, !0)), we.restore()) : (i = ni(_), we.drawImage(i, r - i.width / 2, s - i.height / 2))))
    }
    ...
    function Xn(e, t, n) {
        we.globalAlpha = 1;
        for (var i = 0; i < W.length; ++i)(_ = W[i]).zIndex == n && (_.animate(P), _.visible && (_.skinRot += .002 * P, L = (_ == R ? dn() : _.dir) + _.dirPlus, we.save(), we.translate(_.x - e, _.y - t), we.rotate(L), Nn(_, we), we.restore()))
    }
    ...
    function ri(e, t) {
        ...
        if (!n || t) {
            ...
            else if ("pit trap" == e.name) r.fillStyle = "#a5974c", ai(r, 3, 1.1 * e.scale, 1.1 * e.scale), r.fill(), r.stroke(), r.fillStyle = nt, ai(r, 3, .65 * e.scale, .65 * e.scale), r.fill();
    ...
    function fi(e, t, n, i, r, s, a, o) {
        ct && (J.addProjectile(e, t, n, i, r, s, null, null, a).sid = o)
    }
    ...
    function gi(e) {
        ...
        if (e) {
            var n = Date.now();
            for (t = 0; t < e.length;)(_ = Ei(e[t])) ? (_.index = e[t + 1], _.t1 = void 0 === _.t2 ? n : _.t2, _.t2 = n, _.x1 = _.x, _.y1 = _.y, _.x2 = e[t + 2], _.y2 = e[t + 3], _.d1 = void 0 === _.d2 ? e[t + 4] : _.d2, _.d2 = e[t + 4], _.health = e[t + 5], _.dt = 0, _.visible = !0) : ((_ = $.spawn(e[t + 2], e[t + 3], e[t + 4], e[t + 1])).x2 = _.x, _.y2 = _.y, _.d2 = _.dir, _.health = e[t + 5], $.aiTypes[e[t + 1]].name || (_.name = o.cowNames[e[t + 6]]), _.forcePos = !0, _.sid = e[t], _.visible = !0), t += 7
        }
    }
    var mi = {};
    ...
    function vi(e, t) {
        ...
        n || (n = new u(e[0], e[1], o, s, J, tt, W, Y, l, Ze, et), W.push(n)), n.spawn(t ? H : null), n.visible = !1, n.x2 = void 0, n.y2 = void 0, n.setData(e), t && (U = (R = n).x, D = R.y, Qt(), Cn(), Un(), _n(0), Pe.style.display = "block")
    }
    ...
    window.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e) {
        ...
        , function e() {
            B = Date.now(), P = B - q, q = B
                , function() {
                    if (R && (!C || B - C >= 1e3 / o.clientSendRate)) {
                        C = B;
                        const e = dn();
                        Ln !== e && (Ln = e, r.send("2", e))
                    }
                    if (Mn < 120 && (Mn += .1 * P, Ne.style.fontSize = Math.min(Math.round(Mn), 120) + "px"), R) {
                    ...
                    for (var i = B - 1e3 / o.serverUpdateRate, a = 0; a < W.length + Y.length; ++a)
                        ...
                        , d = D - oe / 2;
                    o.snowBiomeTop - d <= 0 && o.mapScale - o.snowBiomeTop - d >= oe ? (we.fillStyle = "#b6db66", we.fillRect(0, 0, ae, oe)) : o.mapScale - o.snowBiomeTop - d <= 0 ? (we.fillStyle = "#dbc666", we.fillRect(0, 0, ae, oe)) : o.snowBiomeTop - d >= oe ? (we.fillStyle = "#fff", we.fillRect(0, 0, ae, oe)) : o.snowBiomeTop - d >= 0 ? (we.fillStyle = "#fff", we.fillRect(0, 0, ae, o.snowBiomeTop - d), we.fillStyle = "#b6db66", we.fillRect(0, o.snowBiomeTop - d, ae, oe - (o.snowBiomeTop - d))) : (we.fillStyle = "#b6db66", we.fillRect(0, 0, ae, o.mapScale - o.snowBiomeTop - d), we.fillStyle = "#dbc666", we.fillRect(0, o.mapScale - o.snowBiomeTop - d, ae, oe - (o.mapScale - o.snowBiomeTop - d))), Tn || ((Z += ee * o.waveSpeed * P) >= o.waveMax ? (Z = o.waveMax, ee = -1) : Z <= 1 && (Z = ee = 1), we.globalAlpha = 1, we.fillStyle = "#dbc666", qn(f, d, we, o.riverPadding), we.fillStyle = "#91b2db", qn(f, d, we, 250 * (Z - 1))), we.lineWidth = 4, we.strokeStyle = "#000", we.globalAlpha = .06, we.beginPath();
                    for (var p = -U; p < ae; p += oe / 18) p > 0 && (we.moveTo(p, 0), we.lineTo(p, oe));
                    for (var g = -D; g < oe; g += oe / 18) p > 0 && (we.moveTo(0, g), we.lineTo(ae, g));
                    for (we.stroke(), we.globalAlpha = 1, we.strokeStyle = nt, Yn(-1, f, d), we.globalAlpha = 1, we.lineWidth = 5.5, zn(0, f, d), Xn(f, d, 0), we.globalAlpha = 1, a = 0; a < Y.length; ++a)(_ = Y[a]).active && _.visible && (_.animate(P), we.save(), we.translate(_.x - f, _.y - d), we.rotate(_.dir + _.dirPlus - Math.PI / 2), yi(_, we), we.restore());
                    if (Yn(0, f, d), zn(1, f, d), Yn(1, f, d), Xn(f, d, 1), Yn(2, f, d), Yn(3, f, d), we.fillStyle = "#000", we.globalAlpha = .09, f <= 0 && we.fillRect(0, 0, -f, oe), o.mapScale - f <= ae) {
                        var y = Math.max(0, -d);
                    ...
                    for (we.globalAlpha = 1, we.fillStyle = "rgba(0, 0, 70, 0.35)", we.fillRect(0, 0, ae, oe), we.strokeStyle = it, a = 0; a < W.length + Y.length; ++a)
                        if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                            var w = (_.team ? "[" + _.team + "] " : "") + (_.name || "");
                            if ("" != w) {
                                if (we.font = (_.nameScale || 30) + "px Hammersmith One", we.fillStyle = "#fff", we.textBaseline = "middle", we.textAlign = "center", we.lineWidth = _.nameScale ? 11 : 8, we.lineJoin = "round", we.strokeText(w, _.x - f, _.y - d - _.scale - o.nameY), we.fillText(w, _.x - f, _.y - d - _.scale - o.nameY), _.isLeader && On.crown.isLoaded) {
                                    var b = o.crownIconScale;
                                    k = _.x - f - b / 2 - we.measureText(w).width / 2 - o.crownPad, we.drawImage(On.crown, k, _.y - d - _.scale - o.nameY - b / 2 - 5, b, b)
                                }
                                1 == _.iconIndex && On.skull.isLoaded && (b = o.crownIconScale, k = _.x - f - b / 2 + we.measureText(w).width / 2 + o.crownPad, we.drawImage(On.skull, k, _.y - d - _.scale - o.nameY - b / 2 - 5, b, b))
                            }
                            _.health > 0 && (o.healthBarWidth, we.fillStyle = it, we.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y - d + _.scale + o.nameY, 2 * o.healthBarWidth + 2 * o.healthBarPad, 17, 8), we.fill(), we.fillStyle = _ == R || _.team && _.team == R.team ? "#8ecc51" : "#cc5151", we.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY + o.healthBarPad, 2 * o.healthBarWidth * (_.health / _.maxHealth), 17 - 2 * o.healthBarPad, 7), we.fill())
                    ...
                    function(e) {
                        if (R && R.alive) {
                            ...
                            for (var t = 0; t < Vt.length; ++t)(Ht = Vt[t]).update(Je, e);
                            if (Je.globalAlpha = 1, Je.fillStyle = "#fff", si(R.x / o.mapScale * Xe.width, R.y / o.mapScale * Xe.height, 7, Je, !0), Je.fillStyle = "rgba(255,255,255,0.35)", R.team && It)
                                for (t = 0; t < It.length;) si(It[t] / o.mapScale * Xe.width, It[t + 1] / o.mapScale * Xe.height, 7, Je, !0), t += 2;
                            Tt && (Je.fillStyle = "#fc5553", Je.font = "34px Hammersmith One", Je.textBaseline = "middle", Je.textAlign = "center", Je.fillText("x", Tt.x / o.mapScale * Xe.width, Tt.y / o.mapScale * Xe.height)), Et && (Je.fillStyle = "#fff", Je.font = "34px Hammersmith One", Je.textBaseline = "middle", Je.textAlign = "center", Je.fillText("x", Et.x / o.mapScale * Xe.width, Et.y / o.mapScale * Xe.height))
                        }
                    }(P), -1 !== ie.id && Fn(ie.startX, ie.startY, ie.currentX, ie.currentY), -1 !== re.id && Fn(re.startX, re.startY, re.currentX, re.currentY)
                }(), requestAnimFrame(e)
        }(), window.openLink = Oi, window.aJoinReq = Ut, window.follmoo = function() {
            H || (H = !0, I("moofoll", 1))
        }, window.kickFromClan = Dt, window.sendJoin = Lt, window.leaveAlliance = zt, window.createAlliance = Ft, window.storeBuy = Jt, window.storeEquip = Gt, window.showItemInfo = St, window.selectSkinColor = function(e) {
            se = e, Zt()
        }, window.changeStoreIndex = function(e) {
            Wt != e && (Wt = e, Nt())
        }, window.config = o, window.FRVR && window.FRVR.bootstrapper.complete()
}, function(e, t) {
    ! function(e, t, n) {
        function i(e, t) {
            return typeof e === t
