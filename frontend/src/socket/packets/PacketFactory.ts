...
packetTypeMapping[PacketType.PING] = { value: "pp", side: Side.Both };
...
packetTypeMapping[PacketType.DAMAGE_TEXT] = { value: "t", side: Side.Client };
...
packetTypeMapping[PacketType.REMOVE_ALL_OBJ] = { value: "13", side: Side.Server }
